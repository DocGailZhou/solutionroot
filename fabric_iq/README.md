# Fabric IQ Setup and Pipeline Run Guide
...
1. From this repo, locate `fabric_iq/infra/data`.
...
2. Upload all notebooks from `fabric_iq/src/fabric/notebooks`.
...
Execution flow in `main_pipeline.ipynb`:
