...
**Generated**: 2026-03-11 12:01:58  
**Date Range**: 2025-01-01 to 2026-03-31  
**Duration**: 454 days  
**Integration**: Connected to 115,710 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 8,187
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 71 relationships
- **Inventory Records**: 80 stock locations
- **Purchase Orders**: 200 procurement orders  
- **PO Line Items**: 586 order details
...
- `ProductSuppliers.csv` - 71 product-to-supplier mappings with pricing
...
- `PurchaseOrderItems.csv` - 586 line items with specifications
...
*Generation Parameters: 200 orders, 6810 transactions, 15 events*  
