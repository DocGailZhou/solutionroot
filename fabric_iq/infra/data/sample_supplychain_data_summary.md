...
**Generated**: 2026-03-09 16:57:35  
**Date Range**: 2025-01-01 to 2026-03-31  
**Duration**: 454 days  
**Integration**: Connected to 51,447 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 7,845
...
- **Purchase Orders**: 114 procurement orders  
- **PO Line Items**: 333 order details
...
- **Purchase Orders**: 114 orders spanning 90-day historical period
...
- `ProductSuppliers.csv` - 75 product-to-supplier mappings with pricing
...
- `PurchaseOrders.csv` - 114 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 333 line items with specifications
...
*Generation Parameters: 114 orders, 6810 transactions, 15 events*  
