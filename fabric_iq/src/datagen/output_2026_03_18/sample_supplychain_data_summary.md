...
**Date Range**: 2025-10-01 to 2026-04-30  
**Duration**: 211 days  
**Integration**: Connected to 53,742 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 4,214
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 68 relationships
- **Inventory Records**: 73 stock locations
- **Purchase Orders**: 119 procurement orders  
- **PO Line Items**: 349 order details
- **Inventory Transactions**: 3165 movement records
...
- **Purchase Orders**: 119 orders spanning 90-day historical period
...
- **Complete Visibility**: 3165 inventory movements across all transaction types
...
- `ProductSuppliers.csv` - 68 product-to-supplier mappings with pricing
- `SupplyChainEvents.csv` - 15 disruption events and scenarios

### **Inventory Data** (`output/inventory/`)  
- `Inventory.csv` - 73 current stock levels across warehouses
- `InventoryTransactions.csv` - 3165 complete movement audit trail
- `PurchaseOrders.csv` - 119 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 349 line items with specifications
...
*Generation Parameters: 119 orders, 3165 transactions, 15 events*  
