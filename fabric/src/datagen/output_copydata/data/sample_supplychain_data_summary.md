...
**Duration**: 303 days  
**Integration**: Connected to 51,777 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 5,606
...
- **PO Line Items**: 350 order details
...
- `Inventory.csv` - 81 current stock levels across warehouses
...
- `PurchaseOrderItems.csv` - 350 line items with specifications
