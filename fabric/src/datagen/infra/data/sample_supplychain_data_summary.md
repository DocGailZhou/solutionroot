...
**Duration**: 303 days  
**Integration**: Connected to 52,936 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 5,610
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 77 relationships
- **Inventory Records**: 78 stock locations
- **Purchase Orders**: 117 procurement orders  
- **PO Line Items**: 353 order details
...
- `ProductSuppliers.csv` - 77 product-to-supplier mappings with pricing
...
- `PurchaseOrderItems.csv` - 353 line items with specifications
