...
python main_generate_inventory.py -s 2025-01-01 -e 2026-03-31 --auto-scale --graph --copydata .\output_copydata\data --no-display

# Manual parameters
python main_generate_inventory.py -s 2025-01-01 -e 2026-03-31 --num-orders 30 --num-transactions 500 --graph --no-display
```
