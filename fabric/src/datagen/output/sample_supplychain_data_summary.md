...
**Duration**: 303 days  
**Integration**: Connected to 52,778 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 5,599
...
- **Purchase Orders**: 117 procurement orders  
...
- **Purchase Orders**: 117 orders spanning 90-day historical period
...
- `PurchaseOrders.csv` - 117 procurement orders with supplier details  
...
*Generation Parameters: 117 orders, 4545 transactions, 15 events*  
