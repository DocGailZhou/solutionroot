...
**Duration**: 303 days  
**Integration**: Connected to 53,966 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 5,518
...
- **PO Line Items**: 351 order details
...
- `Inventory.csv` - 83 stock levels across warehouses
- `InventoryTransactions.csv` - 4545 movement audit trail
- `PurchaseOrders.csv` - 119 procurement orders  
- `PurchaseOrderItems.csv` - 351 line items with details
