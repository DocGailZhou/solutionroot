...
**Duration**: 211 days  
**Integration**: Connected to 84,223 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 4,517
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 82 relationships
- **Inventory Records**: 83 stock locations
- **Purchase Orders**: 187 procurement orders  
- **PO Line Items**: 560 order details
...
- **Purchase Orders**: 187 orders spanning 90-day historical period
...
- `ProductSuppliers.csv` - 82 product-to-supplier mappings with pricing
- `SupplyChainEvents.csv` - 15 disruption events and scenarios

### **Inventory Data** (`output/inventory/`)  
- `Inventory.csv` - 83 current stock levels across warehouses
- `InventoryTransactions.csv` - 3165 complete movement audit trail
- `PurchaseOrders.csv` - 187 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 560 line items with specifications
...
*Generation Parameters: 187 orders, 3165 transactions, 15 events*  
